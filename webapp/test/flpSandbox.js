		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Topaz Signature Capture",
									"targetURL": "#comborderstatestopazsignature-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comborderstatestopazsignature-display": {
								"semanticObject": "comborderstatestopazsignature",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.borderstates.topazsignature",
									"url": sap.ui.require.toUrl("com/borderstates/topazsignature")
								}
							}
						}
					}
